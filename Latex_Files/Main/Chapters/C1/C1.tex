...
We begin this section by defining what a stochastic process is and how they are applicable to modelling our asset value.
...
\nline{}
A discrete stochastic process is a sequence of random variables which represent observations taken at discrete times, e.g. \(\{X_i\,:\, i \in \}\) being 
