...
ax1.plot(Data['Options']/1e6, linewidth=2, zorder=1, label="Options")
# ax1.plot(Data[Data['Futures'] != 0]['Futures']/1e6, linewidth=2, zorder=1, label="Futures")
# ax1.legend()
ax1.set_title('Average Daily OptionS Trading Volume')
ax1.set_xlabel('Year')
ax1.xaxis.set_minor_formatter(mdates.DateFormatter("%Y"))
ax1.set_ylabel('Average Daily Volume (Millions)')
...
fig.savefig(cwd + "\Latex_Files\Main\Chapters\C1\plots\OptionVolume.png", bbox_inches='tight')